...
export class ReportActivityAbsence implements StrategiesHolder {
    ...
    constructor(req: any) {
        ...
        this.chaine
            ...
            .setNextChaine(ReportActivityResp.getFactorie(this.data, ['full', 'absence']))
            .setNextChaine(ReportActivityResp.getFactorie(this.data, ['null', 'presence']))
